...
import SANG
from SANG.lib.curve.ttypes import *
from SANG.lib.curve.ttypes import Message
...
cl = SANG.LINE()
#cl.login(qr=True)
cl.login(token="En9oLqwLRVmAAorTb6Pa.sG9LpQDx2NQ81bWvVW8v2G.ZIIx80C0RYhenE9te1a7QWXNCI4f0BjVGOQd+0K1nPc=")#1beby
cl.loginResult()
