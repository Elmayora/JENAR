...
#---------------------------------------------------------          
              ...
              if msg.from_ in admin:
                ...
                for i in gid:
                    ki1.leaveGroup(i)
                    ki2.leaveGroup(i)                                      ki3.leaveGroup(i)
                    ki4.leaveGroup(i)                                      ki5.leaveGroup(i)
                    ki6.leaveGroup(i)
                    ki7.leaveGroup(i)
                    ki8.leaveGroup(i)
                    ki9.leaveGroup(i)  
...
#-----------------------------------------------
                ...
                if msg.from_ in admsa:
                        ...
                        Ticket = cl.reissueGroupTicket(msg.to)
                        ki1.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki1.sendText(msg.to,"What Happen Broo"
                        time.sleep(0.2)
                        ki1.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki1.sendText(msg.to,"What Happen Broo"
                        time.sleep(0.2)
                        ...
                        ki3.sendText(msg.to,"Aya Naon"
                        time.sleep(0.2)
                        ki4.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki4.sendText(msg.to,"Kulo Nuwun"
                        time.sleep(0.2)
                        ki5.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki5.sendText(msg.to,"Jembut Manggil Mele"
                        time.sleep(0.2)
                        ki6.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki6.sendText(msg.to,"Ono Opo Tah"
                        time.sleep(0.2)
                        ki7.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki7.sendText(msg.to,"Ada Yang Live Tah"
                        time.sleep(0.2)
                        ki8.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki8.sendText(msg.to,"Kuyyy VCS"
                        time.sleep(0.2)
                        ki9.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki9.sendText(msg.to,"Desah On"
                        time.sleep(0.2)
                        ki10.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki10.sendText(msg.to,"Ojo Brisikkk Nahhh"
                        time.sleep(0.2)
                        G = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        ki1.updateGroup(G)
