...
ki6 = JENAR.LINE()
ki6.login(token="TOKENMU")
ki6.loginResult()

ki7 = JENAR.LINE()
ki7.login(token="TOKENMU")
ki7.loginResult()

ki8 = JENAR.LINE()
ki8.login(token="TOKENMU")
ki8.loginResult()

ki9 = JENAR.LINE()
ki9.login(token="TOKENMU")
ki9.loginResult()

ki10 = JENAR.LINE()
ki10.login(token="TOKENMU")
ki10.loginResult()
...
#------------------------✖ BECK ✖-----------------------------#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid':"uf9a3dbc375bb4c505ba8c9014ffc8147"}
                msg.contentMetadata = {'mid':"uf9a3dbc375bb4c505ba8c9014ffc8147"}
                cl.sendMessage(msg)
                cl.sendMessage(msg)
                cl.sendText(msg.to,"⏫⏫⏫⏫⏫⏫⏫⏫")
...
#------------------------✖ BECK ✖-----------------------------#
                ...
                cl.sendText(msg.to,"「 Kick Mention 」\nType: Respon Group\nStatus: Off \n\n"+ datetime.today().strftime('%H:%M:%S'))
#-----------------------------------------------
            elif msg.text in ["Kuy","Asist @join"]:
                if msg.from_ in admsa:
                        ...
                        Ticket = cl.reissueGroupTicket(msg.to)
                        ki1.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki1.sendText(msg.to,"What Happen Broo"  +  str(ginfo.name)  + "")
                        time.sleep(0.2)
                        ki2.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki2.sendText(msg.to,"Ada Apa Tahh"  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki3.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki3.sendText(msg.to,"Aya Naon"  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki4.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki4.sendText(msg.to,"Kulo Nuwun"  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki5.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki5.sendText(msg.to,"Jembut Manggil Mele"  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki6.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki6.sendText(msg.to,"Ono Opo Tah"  +  str(ginfo.name)  + "")
                        time.sleep(0.2)
                        ki7.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki7.sendText(msg.to,"Ada Yang Live Tah"  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki8.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki8.sendText(msg.to,"Kuyyy VCS"  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki9.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki9.sendText(msg.to,"Desah On"  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki10.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki10.sendText(msg.to,"Ojo Brisikkk Nahhh"  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        G = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        ki1.updateGroup(G)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki1.sendText(msg.to,"Ngusir Nihh"  +  str(ginfo.name)  + "")
                        ki1.leaveGroup(msg.to)
                        ki2.sendText(msg.to,"Yoo Wesss"  +  str(ginfo.name)  + "")
                        ki2.leaveGroup(msg.to)
                        ki3.sendText(msg.to,"Klo Udah Crottt"  +  str(ginfo.name)  + "")
                        ki3.leaveGroup(msg.to)
                        ki4.sendText(msg.to,"Pasti Ngusirrr"  +  str(ginfo.name)  + "")
                        ki4.leaveGroup(msg.to)
                        ki5.sendText(msg.to,"Maunya Enak Doank"  +  str(ginfo.name)  + "")
                        ki5.leaveGroup(msg.to)
                        ki6.sendText(msg.to,"Dasarr Kuprettt"  +  str(ginfo.name)  + "")
                        ki6.leaveGroup(msg.to)
                        ki7.sendText(msg.to,"Gak Punya Perasaan"  +  str(ginfo.name)  + "")
                        ki7.leaveGroup(msg.to)
                        ki8.sendText(msg.to,"Abis Manis"  +  str(ginfo.name)  + "")
                        ki8.leaveGroup(msg.to)
                        ki9.sendText(msg.to,"Semvakkk"  +  str(ginfo.name)  + "")
                        ki9.leaveGroup(msg.to)
                        ki10.sendText(msg.to,"Kau Buang"  +  str(ginfo.name)  + "")
                        ki10.leaveGroup(msg.to)
                    except:
                        pass
#-----------------------------------------------
...
#----------------------------------------------- 
              ...
              if msg.from_ in admin:
                ...
                ki1.sendText(msg.to,"Colokkk Nihhh 😁")
                ki2.sendText(msg.to,"Colokkk Nihhh 😁")
                ki3.sendText(msg.to,"Colokkk Nihhh 😁")
                ki4.sendText(msg.to,"Colokkk Nihhh 😁")
                ki5.sendText(msg.to,"Colokkk Nihhh 😁")
                ki6.sendText(msg.to,"Colokkk Nihhh 😁")
                ki7.sendText(msg.to,"Colokkk Nihhh 😁")
                ki8.sendText(msg.to,"Colokkk Nihhh 😁")
