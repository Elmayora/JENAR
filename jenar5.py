...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        cl.sendText(msg.to,"􀜁􀇔􏿿Bye Mbut😘 "  +  str(ginfo.name)  + "")
...
#-----------------------------------------------------------
                ...
                profile = ki.getProfile()
                text = profile.displayName + " HADIR JURAGAN DUDUL "
                ki.sendText(msg.to, text)
                profile = ki2.getProfile()
                text = profile.displayName + " HADIR JURAGAN DUDUL "
                ki2.sendText(msg.to, text)
                profile = ki3.getProfile()
                text = profile.displayNaame + " HADIR JURAGAN DUDUL"
...
#-----------------------------------------------
                ...
                if msg.from_ in admsa:
                        ...
                        Ticket = cl.reissueGroupTicket(msg.to)
                        ki.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki.sendText(msg.to,"Haloo Mbutt "  +  str(ginfo.name)  + "")
                        time.sleep(0.2)
                        ki2.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki2.sendText(msg.to,"Haloo Mbutt "  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki3.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki3.sendText(msg.to,"Haloo Mbutt "  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki4.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki4.sendText(msg.to,"Haloo Mbutt "  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        ki5.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ki5.sendText(msg.to,"Haloo Mbutt "  +  str(ginfo.name)  + "")
                        time.sleep(0.2),
                        G = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        ki.updateGroup(G)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki.sendText(msg.to,"Bye Bye Mbutt "  +  str(ginfo.name)  + "")
                        ki.leaveGroup(msg.to)
                        ki2.sendText(msg.to,"Bye Bye Mbutt "  +  str(ginfo.name)  + "")
                        ki2.leaveGroup(msg.to)
                        ki3.sendText(msg.to,"Bye Bye Mbutt "  +  str(ginfo.name)  + "")
                        ki3.leaveGroup(msg.to)
                        ki4.sendText(msg.to,"Bye Bye Mbutt "  +  str(ginfo.name)  + "")
                        ki4.leaveGroup(msg.to)
                        ki5.sendText(msg.to,"Bye Bye Mbutt "  +  str(ginfo.name)  + "")
                        ki5.leaveGroup(msg.to)
                    except:
                        pass
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                    	ki3.sendText(msg.to,"Bye ByeMbutt "  +  str(ginfo.name)  + "")
                        ki3.leaveGroup(msg.to)
                    except:
                        pass
#-----------------------------------------------
...
#----------------------------------------------- 
              ...
              if msg.from_ in admin:
                ...
                ki3.sendText(msg.to,"Jebret Matamu 🤣")
