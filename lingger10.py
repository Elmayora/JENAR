...
channel = LineChannel(lingger)
lingger.log("Channel Access Token : " + str(channel.channelAccessToken))

dna1 = LineClient()
dna1.log("Auth Token : " + str(dna1.authToken))
channel1 = LineChannel(dna1)
dna1.log("Channel Access Token : " + str(channel1.channelAccessToken))

dna2 = LineClient()
dna2.log("Auth Token : " + str(dna2.authToken))
channel2 = LineChannel(dna2)
dna2.log("Channel Access Token : " + str(channel2.channelAccessToken))

dna3 = LineClient()
dna3.log("Auth Token : " + str(dna3.authToken))
channel3 = LineChannel(dna3)
dna3.log("Channel Access Token : " + str(channel3.channelAccessToken))

dna4 = LineClient()
dna4.log("Auth Token : " + str(dna4.authToken))
channel4 = LineChannel(dna4)
dna4.log("Channel Access Token : " + str(channel4.channelAccessToken))

dna5 = LineClient()
dna5.log("Auth Token : " + str(dna5.authToken))
channel5 = LineChannel(dna5)
dna5.log("Channel Access Token : " + str(channel5.channelAccessToken))

dna6 = LineClient()
dna6.log("Auth Token : " + str(dna6.authToken))
channel6 = LineChannel(dna6)
dna6.log("Channel Access Token : " + str(channel6.channelAccessToken))

dna7 = LineClient()
dna7.log("Auth Token : " + str(dna7.authToken))
channel7 = LineChannel(dna7)
dna7.log("Channel Access Token : " + str(channel7.channelAccessToken))

dna8 = LineClient()
dna8.log("Auth Token : " + str(dna8.authToken))
channel8 = LineChannel(dna8)
dna8.log("Channel Access Token : " + str(channel8.channelAccessToken))

dna9 = LineClient()
dna9.log("Auth Token : " + str(dna9.authToken))
channel9 = LineChannel(dna9)
dna9.log("Channel Access Token : " + str(channel9.channelAccessToken))

dna10 = LineClient() #Ghost
dna10.log("Auth Token : " + str(dna10.authToken))
channel10 = LineChannel(dna10)
dna10.log("Channel Access Token : " + str(channel10.channelAccessToken))
...
╚════════════════════╝
"""
poll = LinePoll(lingger)
KAC=[lingger,dna1,dna2,dna3,dna4,dna5,dna6,dna7,dna8,dna9]
mid = lingger.getProfile().mid
...
admin=["u8f0af218f675c76448e20811c67a4026"]
owner=["u8f0af218f675c76448e20811c67a4026"]
creator=["u8f0af218f675c76448e20811c67a4026"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def NOTIFIED_READ_MESSAGE(op):
    try:
        if op.param1 in wait2['readPoint']:
            Name = lingger.getContact(op.param2).displayName
...
#------------------Detect Mention-----------------#
        if 'MENTION' in msg.contentMetadata.keys() != None:
        	if wait['detectMention'] == True:
        		contact = lingger.getContact(msg._from)
    ...
    try:
        ...
        if op.type == 5:
            if wait["autoAdd"] == True:
                lingger.findAndAddContactsByMid(op.param1)
                if (wait["message"] in [""," ","\n",None]):
                    pass
                else:
                    lingger.sendText(op.param1,str(wait["message"]))
#--------------Notif Update Group--------------#
        if op.type == 11:
            if wait["ProtectGroup"] == True:
              if op.param2 not in admin:
                 if op.param2 not in Bots:
                 	X = lingger.getGroup(op.param1)
                 	X.preventedJoinByTicket = False
                 	lingger.updateGroup(X)
        ...
        if op.type == 13:
                ...
                if op.param3 in Imid:
                    if op.param2 in mid:
                        ...
                        X.preventJoinByTicket = False
                        ririn.updateGroup(X)
                        Ti = lingger.reissueGroupTicket(op.param1)
        ...
        if op.type == 13:
            ...
            if mid in op.param3:
                ...
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
                        if len(G.members) <= wait["autoCancel"]["members"]:
                            lingger.rejectGroupInvitation(op.param1)
                        else:
                            lingger.acceptGroupInvitation(op.param1)
                    else:
                        lingger.acceptGroupInvitation(op.param1)
                ...
                if matched_list == []:
                    ...
                    lingger.cancelGroupInvitation(op.param1, matched_list)
                ...
                if wait["invite"] == True:
                    ...
                    for s in groups.members:
                        if _name in s.displayName:
                            lingger.sendText(msg.to, _name + " sᴜᴅᴀʜ ᴅɪ ᴅᴀʟᴀᴍ ɢʀᴜᴘ")
                        else:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                lingger.findAndAddContactsByMid(target)
                                lingger.inviteIntoGroup(msg.to,[target])
                                lingger.sendText(msg.to,"Invite " + _name)
                                wait["invite"] = False
                                break                              
                            except:             
                                    lingger.sendText(msg.to,'ᴇʀʀᴏʀ')
                                    wait["invite"] = False
                                    break
            else:
                if wait["invite"] == True:
...
#----------------Notif Leave Group----------------#
        if op.type == 15:
        	dan = lingger.getContact(op.param2)
        	tgb = lingger.getGroup(op.param1)
        	lingger.sendMessage(op.param1, "ɴᴀʜ ᴋᴀɴ ʙᴀᴘᴇʀ {}, ɢᴀᴋ ᴜsᴀʜ ʙᴀʟɪᴋ ᴅɪ {} ʟᴀɢɪ ʏᴀ\nsᴇʟᴀᴍᴀᴛ ᴊᴀʟᴀɴ ᴅᴀɴ sᴇᴍᴏɢᴀʜ ᴛᴇɴᴀɴɢ ᴅɪʟᴜᴀʀ sᴀɴᴀ 😘😘😘".format(str(dan.displayName),str(tgb.name)))
        	lingger.sendContact(op.param1, op.param2)
        	lingger.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net{}".format(dan.picturePath))
#------------------Comment Like-------------------#
...
#-------------------Admin Kicked--------------------#
        if op.type == 19:
           if op.param3 in admin:
               try:
                   lingger.kickoutFromGroup(op.param1,[op.param2])
                   lingger.inviteIntoGroup(op.param1,admin)
               except:
                   try:
                       random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
...
#------------------Receive Come Bye---------------#
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg._from == profile.mid:
                    if "join:" in msg.text:
                        ...
                        try:
                            lingger.acceptGroupInvitationByTicket(list_[1],list_[2])
                            X = lingger.getGroup(list_[1])
                            X.preventJoinByTicket = True
                            lingger.updateGroup(X)
                        except:
                            lingger.sendText(msg.to,"ᴇʀʀᴏʀ")
            if msg.toType == 1:
                if wait["leaveRoom"] == True:
                    lingger.leaveRoom(msg.to)
            if msg.contentType == 16:
                url = msg.contentMetadata("line://home/post?userMid="+mid+"&postId="+"new_post")
                lingger.like(url[25:58], url[66:], likeType=1001)
#---------------------Blacklist User--------------------#
        if op.type == 26:
            msg = op.message
            if msg.contentType == 13:
               if wait["wblack"] == True:
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        lingger.sendText(msg.to,"ᴀʟʀᴇᴀᴅʏ")
                        wait["wblack"] = False
                    else:
                        wait["commentBlack"][msg.contentMetadata["mid"]] = True
                        wait["wblack"] = False
                        lingger.sendText(msg.to,"ᴅᴇᴄɪᴅᴇᴅ ɴᴏᴛ ᴛᴏ ᴄᴏᴍᴍᴇɴᴛ")
                        
               elif wait["dblack"] == True:
                   if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        del wait["commentBlack"][msg.contentMetadata["mid"]]
                        lingger.sendText(msg.to,"ᴅᴇʟᴇᴛᴇᴅ")
                        wait["dblack"] = False

                   else:
                        wait["dblack"] = False
                        lingger.sendText(msg.to,"It is not in the black list")
                   ...
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["dblacklist"] = False
                        lingger.sendText(msg.to,"ɪᴛ ɪs ɴᴏᴛ ɪɴ ᴛʜᴇ ʙʟᴀᴄᴋ ʟɪsᴛ")
#------------------------------------------=Contact=----------------------------------------#
               elif wait["contact"] == True:
                    msg.contentType = 0
                    lingger.sendText(msg.to,msg.contentMetadata["mid"])
                    if 'displayName' in msg.contentMetadata:
                        contact = lingger.getContact(msg.contentMetadata["mid"])
                        try:
                            cu = lingger.channel.getCover(msg.contentMetadata["mid"])
                        except:
                            cu = ""
                        lingger.sendText(msg.to,"[displayName]:\n" + msg.contentMetadata["displayName"] + "\n[mid]:\n" + msg.contentMetadata["mid"] + "\n[statusMessage]:\n" + contact.statusMessage + "\n[pictureStatus]:\nhttp://dl.profile.line-cdn.net/" + contact.pictureStatus + "\n[coverURL]:\n" + str(cu))
                    else:
                        contact = lingger.getContact(msg.contentMetadata["mid"])
                        try:
                            cu = lingger.channel.getCover(msg.contentMetadata["mid"])
                ...
                if wait["timeline"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        msg.text = "URLâ†’\n" + msg.contentMetadata["postEndUrl"]
                    lingger.sendText(msg.to,msg.text)
...
#------------------------Key Public----------------------#
                ...
                if wait["lang"] == "JP":
                    lingger.sendText(msg.to,helpMessage)
                else:
                    lingger.sendText(msg.to,helpt)
            elif "Id" == msg.text:
                lingger.sendText(msg.to,msg.to)
            elif msg.text in ["Mid ku","mid ku","My mid","Mid saya"]:
                lingger.sendText(msg.to,msg._from)
            elif msg.text in ["Me"]:
                lingger.sendContact(msg.to,msg._from)
                ...
                for a in range(k+1):
                    ...
                    for i in group.members[a*100 : (a+1)*100]:
                        ...
                        s += 7
                        txt += u'@Alin \n'
                    lingger.sendMessage(msg.to, text=txt, contentMetadata={u'MENTION': json.dumps({'MENTIONEES':b})}, contentType=0)
                    lingger.sendMessage(msg.to, "ᴛᴏᴛᴀʟ {} ᴍᴇɴᴛɪᴏɴ".format(str(len(nama))))
                ...
                try:
                    ...
                    contact = lingger.getContact(mid)
                    ...
                    ret_ += "\n╚══[ ᴅᴏɴ'ᴛ ʙᴇ ʀᴇᴍᴀᴋᴇ 😝 ]"
                    lingger.sendContact(msg.to, "ueca4120a9d7b0e4a9e7f4f1b1b96a436")
                ...
                try:
                    ...
                    ret_ += "\n╠════════════════"
                    ret_ += "\n╠✪〘 line.me/ti/p/~sang_reck 〙"
                    ret_ += "\n╚════════════════"
                    lingger.sendContact(msg.to, "u469b2ab170827ec56d83307d9d89d55e")
                    lingger.sendMessage(msg.to,"ᴡᴀɪᴛɪɴɢ ғᴏʀ ᴏᴡɴᴇʀʟɪsᴛ...")
                    lingger.sendMessage(msg.to, str(ret_))
                except Exception as e:
                    lingger.sendMessage(msg.to, str(e))
            	...
            	if admin == []:
            		lingger.sendMessage(msg.to,"ᴛʜᴇ ᴀᴅᴍɪɴʟɪsᴛ ɪs ᴇᴍᴘᴛʏ")
            	else:
            		lingger.sendMessage(msg.to,"ᴡᴀɪᴛɪɴɢ ғᴏʀ ᴀᴅᴍɪɴʟɪsᴛ...")
            		mc = "╔════════════════\n╠✪➣  ✰ ᴅɴᴀ ʙᴏᴛ ✰\n╠══✪〘 ᴀᴅᴍɪɴʟɪsᴛ 〙✪═══\n"
            		for mi_d in admin:
                ...
                lingger.sendMessage(msg.to,responsename)
            	...
            	lingger.sendText(msg.to,"ᴀʟʀᴇᴀᴅʏ ᴏɴ")
                ...
                lingger.sendContact(msg.to, mid)
                ...
                lingger.sendText(msg.to, "❂➣ ʟᴏᴀᴅɪɴɢ...")
                sp = int(round(time.time() *1000))
                lingger.sendText(msg.to,"ᴍʏ sᴘᴇᴇᴅ : %sms" % (sp - op.createdTime))

            elif msg.text in ["Speed","speed"]:
                start = time.time()
                lingger.sendText(msg.to, "❂➣ ʟᴏᴀᴅɪɴɢ...")
                elapsed_time = time.time() - start
                lingger.sendText(msg.to, "ᴍʏ sᴘᴇᴇᴅ : %sms" % (elapsed_time))
                
            elif msg.text in ["Auto like"]:
                wait["likeOn"] = True
                lingger.sendText(msg.to,"sᴇɴᴅ ᴜʀ ᴘᴏsᴛ")
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        if ginfo.preventedJoinByTicket == True:
                            ...
                            u = "ᴏᴘᴇɴ "
                        lingger.sendText(msg.to,"[ɢʀᴏᴜᴘ ɴᴀᴍᴇ]\n" + str(ginfo.name) + "\n[ɢɪᴅ]\n" + msg.to + "\n[ɢʀᴏᴜᴘ ᴄʀᴇᴀᴛᴏʀ]\n" + gCreator + "\n[ᴘʀᴏғɪʟᴇ sᴛᴀᴛᴜs]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus + "\nᴍᴇᴍʙᴇʀs:" + str(len(ginfo.members)) + "ᴍᴇᴍʙᴇʀs\nᴘᴇɴᴅɪɴɢ:" + sinvitee + "ᴘᴇᴏᴘʟᴇ\nᴜʀʟ:" + u + "ɪᴛ ɪs ɪɴsɪᴅᴇ")
                    else:
                        lingger.sendText(msg.to,"[ɢʀᴏᴜᴘ ɴᴀᴍᴇ]\n" + str(ginfo.name) + "\n[ɢɪᴅ]\n" + msg.to + "\n[ɢʀᴏᴜᴘ ᴄʀᴇᴀᴛᴏʀ]\n" + gCreator + "\n[ᴘʀᴏғɪʟᴇ sᴛᴀᴛᴜs]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus)
                else:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴄᴀɴ ɴᴏᴛ ʙᴇ ᴜsᴇᴅ ᴏᴜᴛsɪᴅᴇ ᴛʜᴇ ɢʀᴏᴜᴘ")
                    else:
                        lingger.sendText(msg.to,"ɴᴏᴛ ғᴏʀ ᴜsᴇ ʟᴇss ᴛʜᴀɴ ɢʀᴏᴜᴘ")
...
#------------------------Key Admin----------------------#
               ...
               if msg._from in admin:
               	if msg.toType == 2:
                    X = lingger.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    lingger.updateGroup(X)
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                    else:
                        lingger.sendText(msg.to,"ǫʀ ᴀʟʀᴇᴀᴅʏ ᴏᴘᴇɴ")
                else:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴄᴀɴ'ᴛ ʙᴇ ᴜsᴇᴅ ᴏᴜᴛsɪᴅᴇ ᴛʜᴇ ɢʀᴏᴜᴘ")
                    else:
                        lingger.sendText(msg.to,"ɴᴏᴛ ғᴏʀ ᴜsᴇ ʟᴇss ᴛʜᴀɴ ɢʀᴏᴜᴘ")
              ...
              if msg._from in admin:
                if msg.toType == 2:
                    ...
                    lingger.updateGroup(X)
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ǫʀ ᴄᴏᴅᴇ ʜᴀs ʙᴇᴇɴ ᴄʟᴏsᴇᴅ")
                    else:
                        lingger.sendText(msg.to,"ʜᴀs ʙᴇᴇɴ ᴄʟᴏsᴇᴅ")
                else:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ɴᴏᴛ ғᴏʀ ᴜsᴇ ʟᴇss ᴛʜᴀɴ ɢʀᴏᴜᴘ")
                    else:
                  ...
                  lingger.sendText(msg.to,"ᴀᴄᴄᴇs ᴅᴇɴɪᴇᴅ.")
                  lingger.sendText(msg.to,"ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴀᴄᴄᴇssᴇᴅ ʙʏ ᴀᴅᴍɪɴ.")
              ...
              if msg._from in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        lingger.sendText(msg.to,"ᴀʟʀᴇᴀᴅʏ ᴏᴘᴇɴ")
                else:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴄᴀɴ ɴᴏᴛ ʙᴇ ᴜsᴇᴅ ᴏᴜᴛsɪᴅᴇ ᴛʜᴇ ɢʀᴏᴜᴘ")
                    else:
              ...
              if msg._from in admin:
              	lingger.sendContact(to, "u8f0af218f675c76448e20811c67a4026")
            elif msg.text in ["CloseQR On","closeqr on"]:
               if msg._from in admin:
                if wait["CloseQR"] == True:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴄʟᴏsᴇ ǫʀ ᴏɴ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
                    wait["CloseQR"] = True
               ...
               if msg._from in admin:
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴀʟʀᴇᴀᴅʏ ᴏғғ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
                    wait["contact"] = False
            	...
            	if msg._from in admin:
            		...
            		wait["Sider"] = True
            		lingger.sendText(msg.to,"sɪᴀᴘ ᴏɴ ᴄᴇᴋ sɪᴅᴇʀ")
            	...
            	if msg._from in admin:
            		if msg.to in cctv['point']:
            			...
            			wait["Sider"] = False
            			lingger.sendText(msg.to, "ᴄᴇᴋ sɪᴅᴇʀ ᴏғғ")                        
               ...
               if msg._from in admin:
                ...
                lingger.sendText(msg.to,md + "╚═════[ ✯ ᴅɴᴀ ʙᴏᴛ ✯ ]═════╝")
               ...
               if msg._from in admin:
                if msg.toType == 2:
                    ...
                    lingger.sendText(msg.to,"ɪᴛ ᴄᴀɴ'ᴛ ʙᴇ ᴜsᴇᴅ ʙᴇsɪᴅᴇs ᴛʜᴇ ɢʀᴏᴜᴘ.")
            elif "Invitemid " in msg.text:
               if msg._from in admin:
                midd = msg.text.replace("Invitemid ","")
                lingger.findAndAddContactsByMid(midd)
                lingger.inviteIntoGroup(msg.to,[midd])
            elif msg.text in ["Invite","invite"]:
               if msg._from in admin:
                wait["invite"] = True
                lingger.sendText(msg.to,"sᴇɴᴅ ᴄᴏɴᴛᴀᴄᴛ")
                
            elif msg.text in ["Procancel On","Procancel on","procancel on","Pc on"]:
               if msg._from in admin:
                if wait["Protectcancel"] == True:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴘʀᴏᴛᴇᴄᴛ ᴄᴀɴᴄᴇʟ ᴏɴ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
               ...
               if msg._from in admin:
                if wait["Protectcancel"] == False:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴘʀᴏᴛᴇᴄᴛ ᴄᴀɴᴄᴇʟ ᴏғғ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
               ...
               if msg._from in admin:
                if wait["ProtectInvite"] == True:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴘʀᴏᴛᴇᴄᴛ ɪɴᴠɪᴛᴇ ᴏɴ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
               ...
               if msg._from in admin:
                if wait["ProtectInvite"] == False:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴘʀᴏᴛᴇᴄᴛ ɪɴᴠɪᴛᴇ ᴏғғ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
               ...
               if msg._from in admin:
                if wait["ProtectJoin"] == True:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴀʟʀᴇᴀᴅʏ ᴀᴄᴛɪᴠᴇ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
                    wait["ProtectJoin"] = True
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴀɴᴛɪ ᴊᴏɪɴ ᴍᴏᴅᴇ ᴏɴ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
               ...
               if msg._from in admin:
                if wait["ProtectJoin"] == False:
                    ...
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴀɴᴛɪ ᴊᴏɪɴ ᴍᴏᴅᴇ ᴏғғ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
               ...
               if msg._from in admin:
                if wait["ProtectQR"] == True:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴘʀᴏᴛᴇᴄᴛ ǫʀ ᴏɴ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
                    wait["ProtectQR"] = True
               ...
               if msg._from in admin:
                if wait["ProtectQR"] == False:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴘʀᴏᴛᴇᴄᴛ ǫʀ ᴏғғ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
               ...
               if msg._from in admin:
                ...
                if wait["lang"] == "JP":
                    lingger.sendText(msg.to,"ᴀʟʟ ɪɴᴠɪᴛᴀᴛɪᴏɴs ʜᴀᴠᴇ ʙᴇᴇɴ ʀᴇғᴜsᴇᴅ")
                else:
                    lingger.sendText(msg.to,"sᴇᴍᴜᴀ ɢʀᴜᴘ sᴜᴅᴀʜ ᴅɪʙᴀᴛᴀʟᴋᴀɴ")
              ...
              if msg._from in admin:
               ...
               if msg._from in admin:
                ...
                for g in gs.members:
                    if _kicktarget == g.displayName:
                        ...
                        if targets == []:
                            lingger.sendText(msg.to,"ɴᴏᴛ ғᴏᴜɴᴅ")
                        else:
                            for target in targets:
                                try:
                ...
                if msg.toType == 2:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        lingger.sendText(msg.to,"ᴛᴀʀɢᴇᴛ ɴᴏᴛ ғᴏᴜɴᴅ")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                lingger.sendText(msg.to,"ᴛᴀʀɢᴇᴛ ʀᴇᴀᴅʏ")
                            except:
                                lingger.sendText(msg.to,"sᴜᴄᴄᴇs")
               ...
               if msg._from in admin:
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        lingger.sendText(msg.to,"ᴛʜᴇʀᴇ ᴡᴀs ɴᴏ ʙʟᴀᴄᴋʟɪsᴛ ᴜsᴇʀ")
                        return
                    for jj in matched_list:
                        lingger.kickoutFromGroup(msg.to,[jj])
                    lingger.sendText(msg.to,"ᴜʀ ғᴠᴄᴋɪɴɢ ʙɪᴛɔʜ")
               ...
               if msg._from in admin:
                if wait["blacklist"] == {}:
                    lingger.sendText(msg.to,"ɴᴏᴛʜɪɴɢ")
                else:
                    lingger.sendText(msg.to,"ʙʟᴀᴄᴋʟɪsᴛ ᴜsᴇʀ'")
                    mc = ""
                    for mi_d in wait["blacklist"]:
                        mc += "->" +ririn.getContact(mi_d).displayName + "\n"
                    lingger.sendText(msg.to,mc)
               ...
               if msg._from in admin:
                if msg.toType == 2:
                    ...
                    for mm in matched_list:
                        cocoa += mm + "\n"
                    lingger.sendText(msg.to,cocoa + "")
#-----------------------Key Owner-----------------------#
            elif msg.text in ["Alwaysread on"]:
                wait["alwaysRead"] = True
                lingger.sendText(msg.to,"Always Read Sudah Aktif")

            elif msg.text in ["Alwaysread off"]:
                wait["alwaysRead"] = False
                lingger.sendText(msg.to,"Always Read Sudah Di Nonaktifkan") 

            elif msg.text in ["Glist"]:
               if msg._from in Owner:
                  dna1.sendText(msg.to,"「ɢʀᴏᴜᴘ」\nᴡᴀɪᴛɪɴɢ ғᴏʀ : ɢʀᴏᴜᴘ ʟɪsᴛ")
                  gid = lingger.getGroupIdsJoined()
                  h = ""
                  for i in gid:
               ...
               if msg._from in Owner:
                  lingger.sendText(msg.to, "ʙᴏᴛ ʜᴀᴠᴇ ʙᴇᴇɴ ʀᴇsᴛᴀʀt")
                  restart_program()
                  print ("Restart")
               ...
               if msg._from in Owner:
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        lingger.cancelGroupInvitation(msg.to, gInviMids)
                    else:
                        if wait["lang"] == "JP":
                            lingger.sendText(msg.to,"ɴᴏ ᴏɴᴇ ɪs ɪɴᴠɪᴛɪɴɢ")
                        else:
                            lingger.sendText(msg.to,"sᴏʀʀʏ, ɴᴏʙᴏᴅʏ ᴀʙsᴇɴᴛ")
                else:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴄᴀɴ'ᴛ ʙᴇ ᴜsᴇᴅ ᴏᴜᴛsɪᴅᴇ ᴛʜᴇ ɢʀᴏᴜᴘ")
                    else:
               ...
               if msg._from in Owner:
               	...
               	lingger.sendText(msg.to,"line://home/post?userMid="+mid+"&postId="+ririn.new_post(tl_text)["result"]["post"]["postInfo"]["postId"])                        

            elif "Cn " in msg.text:
               if msg._from in Owner:
                string = msg.text.replace("Cn ","")
                if len(string.decode('utf-8')) <= 10000000000:
                    profile = lingger.getProfile()
                    profile.displayName = string
                    lingger.updateProfile(profile)
                    lingger.sendText(msg.to,"ᴜᴘᴅᴀᴛᴇ ɴᴀᴍᴇs" + string)
               ...
               if msg._from in Owner:
                ...
                if len(string.decode('utf-8')) <= 100000000000000:
                    ...
                    lingger.updateProfile(profile)
                    lingger.sendText(msg.to,"()ᴜᴘᴅᴀᴛᴇ ʙɪᴏ→" + string + "←")
               ...
               if msg._from in Owner:
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ɴᴏᴛ ᴀᴄᴛɪᴠᴇ")
                    else:
                        lingger.sendText(msg.to,"ᴅᴏɴᴇ")
                else:
                    wait["autoJoin"] = False
               ...
               if msg._from in Owner:
                try:
                    ...
                    if strnum == "off":
                        ...
                        if wait["lang"] == "JP":
                            lingger.sendText(msg.to,"ɪɴᴠɪᴛᴀᴛɪᴏɴ ʀᴇғᴜsᴇᴅ ᴛᴜʀɴᴇᴅ ᴏғғ\ɪɴᴛᴏ ᴛᴜʀɴ ᴏɴ ᴘʟᴇᴀsᴇ sᴘᴇᴄɪғʏ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴏғ ᴘᴇᴏᴘʟᴇ ᴀɴᴅ sᴇɴᴅ")
                        else:
                            lingger.sendText(msg.to,"å…³äº†é‚€è¯·æ‹’ç»ã€‚è¦æ—¶å¼€è¯·æŒ‡å®šäººæ•°å‘é€")
                    else:
                        num =  int(strnum)
                        wait["autoCancel"]["on"] = True
                        if wait["lang"] == "JP":
                            lingger.sendText(msg.to,strnum + "ᴛʜᴇ ɢʀᴏᴜᴘ ᴏғ ᴘᴇᴏᴘʟᴇ ᴀɴᴅ ʙᴇʟᴏᴡ ᴅᴇᴄɪᴅᴇᴅ ᴛᴏ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ʀᴇғᴜsᴇ ɪɴᴠɪᴛᴀᴛɪᴏɴ")
                        else:
                            lingger.sendText(msg.to,strnum + "ä½¿äººä»¥ä¸‹çš„å°ç»„ç”¨è‡ªåŠ¨é‚€è¯·æ‹’ç»")
                except:
                    if wait["lang"] == "JP":
                        lingger.sendText(msg.to,"ᴠᴀʟᴜᴇ ɪs ᴡʀᴏɴɢ")
                    else:
                        lingger.sendText(msg.to,"ʙɪᴢᴀʀʀᴇ ʀᴀᴛɪɴɢs")
               ...
               if msg._from in Owner:
                if wait["leaveRoom"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        lingger.sendText(msg.to,"è¦äº†å¼€ã€‚")
               ...
               if msg._from in Owner:
                if wait["timeline"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        lingger.sendText(msg.to,"è¦äº†å…³æ–­ã€‚")
            elif msg.text in ["Group id","ç¾¤çµ„å…¨id"]:
               if msg._from in Owner:
                gid = lingger.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[%s]:%s\n" % (lingger.getGroup(i).name,i)
                lingger.sendText(msg.to,h)
...
#--------------------------Group Bc Start-------------------------------------#
               ...
               if msg._from in Owner:
                  ...
                  a = lingger.getGroupIdsJoined()
                  for manusia in a:
                    lingger.sendText(manusia, (bctxt))
#--------------------------Group Bc Finish------------------------------------#                      
            elif msg.text in ["Runtime"]:
               if msg._from in Owner:
                runtime = time.time()-startBot
                elapsed_time = format_timespan(time.time()-startBot)
                lingger.sendText(msg.to,"ʀᴜɴɴɪɴɢ ɪɴ %s" % (elapsed_time))
               ...
               if msg._from in Owner:
                if msg.toType == 2:
                    ...
                    for _mid in gMembMids:
                        lingger.cancelGroupInvitation(msg.to,[_mid])
                    lingger.sendText(msg.to,"ɪ ᴘʀᴇᴛᴇɴᴅᴇᴅ ᴛᴏ ᴄᴀɴᴄᴇʟ ᴀɴᴅ ᴄᴀɴᴄᴇʟᴇᴅ.")
                    
            elif msg.text in ["Respontag on","Autorespon on","Respon on","respon on"]:
            	if msg._from in Owner:
            		wait['detectMention'] = True
            		lingger.sendText(msg.to,"ᴀᴜᴛᴏ ʀᴇsᴘᴏɴ ᴛᴀɢ ᴏɴ")
                
            elif msg.text in ["Respontag off","Autorespon off","Respon off","respon off"]:
            	if msg._from in Owner:
                    wait['detectMention'] = False
                    lingger.sendText(msg.to,"ᴀᴜᴛᴏ ʀᴇsᴘᴏɴ ᴛᴀɢ ᴏғғ")
            
            elif msg.text in ["Kicktag on","kicktag on","Responkick on","responkick on"]:
            	if msg._from in Owner:
                    wait['kickMention'] = True
                    lingger.sendText(msg.to,"ᴀᴜᴛᴏ ᴋɪᴄᴋ ᴛᴀɢ ᴏɴ")
                
            elif msg.text in ["Kicktag off","kicktag off","Responkick off","responkick off"]:
            	if msg._from in Owner:
                    wait['kickMention'] = False
                    lingger.sendText(msg.to,"ᴀᴜᴛᴏ ᴋɪᴄᴋ ᴛᴀɢ ᴏғғ")
               ...
               if msg.toType == 2:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            lingger.sendText(msg.to,"ᴀᴅᴍɪɴ ᴅᴀ ᴅɪᴛᴀᴍʙᴀʜᴋᴀɴ")
                        except:
                            pass
              else:
              	lingger.sendText(msg.to,"ᴄᴏᴍᴍᴀɴᴅ ᴅᴇɴɪᴇᴅ.")
              	lingger.sendText(msg.to,"ᴏᴡɴᴇʀ ᴘᴇʀᴍɪssɪᴏɴ ʀᴇǫᴜɪʀᴇᴅ.")
              ...
              if msg._from in Owner:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            lingger.sendText(msg.to,"ᴀᴅᴍɪɴ ᴅɴᴀ ᴅɪʜᴀᴘᴜs")
                        except:
                            pass
              else:
              	lingger.sendText(msg.to,"ᴄᴏᴍᴍᴀɴᴅ ᴅᴇɴɪᴇᴅ.")
